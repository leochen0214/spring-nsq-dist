...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="center">
							...
							<fo:block font-family="PingFang SC" font-size="20pt" font-weight="bold" padding="10mm">
								<xsl:value-of select="d:info/d:title"/>
							</fo:block>
							<fo:block font-family="PingFang SC" font-size="14pt" padding-before="2mm">
								<xsl:value-of select="d:info/d:subtitle"/>
							</fo:block>
							<fo:block font-family="PingFang SC" font-size="14pt" padding="2mm">
					...
					<fo:table-row>
						<fo:table-cell text-align="center">
							<fo:block font-family="PingFang SC" font-size="14pt" padding="5mm">
					...
					<fo:table-row>
						<fo:table-cell text-align="center">
							<fo:block font-family="PingFang SC" font-size="10pt" padding="10mm">
							...
							<fo:block font-family="PingFang SC" font-size="10pt" padding="5mm">
								<xsl:value-of select="d:info/d:pubdate"/>
							</fo:block>

							<fo:block font-family="PingFang SC" font-size="10pt" padding="5mm" padding-before="25em">
								<xsl:text>Copyright &#xA9; </xsl:text><xsl:value-of select="d:info/d:copyright"/>
							</fo:block>

							<fo:block font-family="PingFang SC" font-size="8pt" padding="1mm">
	...
	<!-- Default Font size -->
	<xsl:param name="body.font.family">PingFang SC</xsl:param>
	<xsl:param name="body.font.master">10</xsl:param>
	<xsl:param name="body.font.small">8</xsl:param>
	<xsl:param name="title.font.family">PingFang SC</xsl:param>
